...
const Contact = () => {
  ...
  return (
  <>
    {isAboveLarge ? (  <section id="contact" className="contact">
    {/* HEADINGS */}
  ...
  <div className='w-full bg-[blue] py-5 px-5'>
    <div className='w-full bg-[#FFF] py-5 px-2'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        <div className=''>

          <div>
            <h1 className='text-2xl mb-2'>Send A Message</h1>
            <input
              type="text"
              class="
      form-control
